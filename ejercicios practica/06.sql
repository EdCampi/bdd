...
INSERT INTO docentes (legajo, nombre, apellido, inicio)
VALUES ('1234', 'Ana', 'Pérez', 1991),
...
INSERT INTO materias (codigo, legajo_docente, nombre)
VALUES ('75.01', NULL, 'Análisis Matemático I'),
...
INSERT INTO alumnos (nombre, apellido, dni, padron)
VALUES ('Juan', 'Rodríguez', '30111222', '103888'),
...
INSERT INTO materias_alumnos (codigo_materia, padron_alumno, nota, anio, cuatrimestre)
VALUES ('75.02', '103888', 8, 2023, 1),
...
FROM (SELECT alumnos.nombre,
      ...
      FROM alumnos
               INNER JOIN materias_alumnos
                          ON alumnos.padron = materias_alumnos.padron_alumno) as m_a
WHERE m_a.codigo_materia = '66.11'
  AND m_a.anio = 2023
  AND m_a.cuatrimestre = 2;
